...
class PageAdminController extends Controller
{
    ...
    {
        if (
            false === $this->admin->isGranted('EDIT') || false === $this->get('sonata.page.admin.block')->isGranted('LIST')
        ) {
            throw new AccessDeniedException();
        }

        $id = $request->get($this->admin->getIdParameter()); //id -> x(page_id)
        ...
        return $this->render('SonataPageBundle:PageAdmin:compose.html.twig', $params);
    }
